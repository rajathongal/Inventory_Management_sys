...
from .models import *
from invent.models import Desktop, Laptop, Mobile
...
class NewQueuedDesktopForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super(NewQueuedDesktopForm, self).__init__(*args, **kwargs)
...
class NewQueuedMobileForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super(NewQueuedMobileForm, self).__init__(*args, **kwargs)
        self.fields['fill'].widget.attrs = {
            'class': 'form-control',
        }
...
class OrderAddMobile(forms.Form):
    size = forms.ChoiceField(label='Size', choices=Mobile.SIZE_CHOICES)
    size.widget.attrs={'class': 'form-control'}
    fill = forms.ChoiceField(label='Fill Type', choices=Mobile.FILL_CHOICES)
    fill.widget.attrs = {'class': 'form-control'}
    hm = forms.IntegerField(label="Quantity")
    hm.widget.attrs = {'class': 'form-control'}


class QueuedDesktopForm(forms.Form):
    fill = forms.ChoiceField(label='Fill Type', choices=Desktop.FILL_CHOICES)
    fill.widget.attrs = {'class': 'form-control'}
    hm = forms.IntegerField(label="Quantity")
    hm.widget.attrs = {'class': 'form-control'}
    class Meta:
