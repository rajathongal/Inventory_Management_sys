...
urlpatterns = [
    ...
    url(r'^orders/new/(?P<pk>[0-9]+)/new_queued_tub/$', views.NewQueuedDesktop.as_view(), name='new_queued_tub'),
    url(r'^orders/new/(?P<pk>[0-9]+)/new_queued_bottle/$', views.NewQueuedMobile.as_view(), name='new_queued_bottle'),
